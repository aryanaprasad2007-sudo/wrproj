...
|---|---|---|
| **CLOSE** | Claude can finish it outright | done immediately, in parallel, no confirmation round-trip |
...
```bash
py -3.12 "C:\Users\aware\OneDrive\Desktop\wrproj\.claude\skills\speedrun\triage.py"
```
...
**Hard boundary, and it is not negotiable:** Claude does not type his
...
`https://claude.ai/code/artifact/98bafd13-a2a6-4b05-83a8-84c357fa4dc1`
...
- Never bare `python` — `py -3.12`. See CLAUDE.md.
