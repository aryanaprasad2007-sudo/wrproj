...
description: Sync Ari's open Docket tasks onto Google Calendar and Todoist for the coming week, fitting each one into a real free block instead of leaving it as a line on a list. Use when he says "sync my docket to calendar", "schedule my week", "plan my week from the docket", "put my tasks on the calendar", "block time for my to-dos", or anything asking Claude to turn the Docket's worklist into an actual weekly schedule (and mirror it to Todoist).
---
