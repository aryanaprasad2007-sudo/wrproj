...
Migrated from AGENTS.md's "Workflow: turning footage into a regression test"
...
# Codex reads the sheets in chat and labels them
...
example, and AGENTS.md's "Scored against ground truth" section for what the
